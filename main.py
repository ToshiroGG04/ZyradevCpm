...
from cpmzyradev import CPMzyradev

__CHANNEL_USERNAME__ = "toshirocpmchannel"
__GROUP_USERNAME__   = "zyrachat"
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - t.me/pbzyra"
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, f' ‌           𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: @{__CHANNEL_TOSHIROCPM__} 𝐎𝐫 @{__MAIN_PBZYRA__}'))
    print(Colorate.Horizontal(Colors.rainbow, '=================================================================='))
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.rainbow, f'Access Key : {data.get("09042021")}.'))
    
    print(Colorate.Horizontal(Colors.rainbow, f'Telegram ID: {data.get("6371760372")}.'))
    
    print(Colorate.Horizontal(Colors.rainbow, f'Balance $  : {(data.get("Unlimited") if not data.get("is_unlimited") else "Unlimited")}.'))
...
def load_client_details():
    ...
    print(Colorate.Horizontal(Colors.rainbow, f'Ip Address : {data.get("210.138.184.59")}.'))
    print(Colorate.Horizontal(Colors.rainbow, f'Location   : {data.get("tokyo japan")} {data.get("kanto")} {data.get("+81")}.'))
    print(Colorate.Horizontal(Colors.rainbow, f'Country    : {data.get("japan")} {data.get("191-0000")}.'))
